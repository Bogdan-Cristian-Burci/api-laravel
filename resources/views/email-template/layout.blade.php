        ...
        <td width="640">
            <table border="0" cellpadding="0" cellspacing="0" width="640" style="margin:auto;background: white;padding: 20px;border-radius: 8px;">
                ...
                <tr style="text-align: center">
                    <td width="100%">
                        <img src="{{asset('assets/images/logo_profiduciaria_black.png')}}" alt="Pro Fiduciaria" style="width:200px" />
                    </td>
                </tr>
                <tr>
                    <td>
                ...
                <tr style="text-align: center">
                    <td style="padding-top: 20px">
                        <a href="https://www.facebook.com/ProFiduciaria/" style="margin-right: 10px;text-decoration: none;">
                            <img src="{{asset('assets/icons/social/Facebook-48x48.png')}}" alt="Facebook" style="width:30px;height:30px"/>
                        </a>
                        <a href="" style="margin-right: 10px;text-decoration: none;">
                            <img src="{{asset('assets/icons/social/YouTube-48x48.png')}}" alt="Youtube" style="width:30px;height:30px"/>
                        </a>
                        <a href="https://www.youtube.com/channel/UCx1k768KMZh61g5dsHOez5Q" style="margin-right: 10px;text-decoration: none;">
                            <img src="{{asset('assets/icons/social/LinkedIn-48x48.png')}}" alt="Linkedin" style="width:30px;height:30px"/>
                        </a>
                    </td>
                </tr>
                </tbody>
